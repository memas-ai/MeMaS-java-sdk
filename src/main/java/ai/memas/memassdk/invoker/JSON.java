...
public class JSON {
...

    {
        ...
        gsonBuilder.registerTypeAdapterFactory(new ai.memas.memassdk.model.Citation.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new ai.memas.memassdk.model.CitedDocument.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new ai.memas.memassdk.model.DeleteCorpusRequest.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new ai.memas.memassdk.model.Memorize200Response.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new ai.memas.memassdk.model.Memorize400Response.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new ai.memas.memassdk.model.MemorizeRequest.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new ai.memas.memassdk.model.MemorizeRequestAllOf.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new ai.memas.memassdk.model.RecallRequest.CustomTypeAdapterFactory());
